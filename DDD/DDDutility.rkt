...
(define poison-attack (lambda (x y w)
                       (set-BATTLE-TEXT! w (cons "SPECIAL-A-CON2" 0))
                       (set-BATTLE-STATUS! w (list (CHARACTER-Name y) "POISON-ATTACK" (CHARACTER-Name x) "毒"))
                       (sleep 1)
                       (set-CHARACTER-Ali! x `(0 ,(random 1 3) 0 0 0 0))))
(define paralsys-attack (lambda (x y w)
                       (set-BATTLE-TEXT! w (cons "SPECIAL-A-CON" 0))
                       (set-BATTLE-STATUS! w (list (CHARACTER-Name y) "PARALYSYS-ATTACK" (CHARACTER-Name x) "麻痺"))
                       (sleep 1)
                       (set-CHARACTER-Ali! x `(0 0 ,(random 1 3) 0 0 0))))
(define silence-attack (lambda (x y w)
                       (set-BATTLE-TEXT! w (cons "SPECIAL-A-CON" 0))
                       (set-BATTLE-STATUS! w (list (CHARACTER-Name y) "SILENCE-ATTACK" (CHARACTER-Name x) "沈黙"))
                       (sleep 1)
                       (set-CHARACTER-Ali! x `(0 0 0 ,(random 1 3) 0 0))))
(define stone-attack (lambda (x y w)
                       (set-BATTLE-TEXT! w (cons "SPECIAL-A-CON" 0))
                       (set-BATTLE-STATUS! w (list (CHARACTER-Name y) "STONE-ATTACK" (CHARACTER-Name x) "石化"))
                       (sleep 1)
                       (set-CHARACTER-Ali! x `(0 0 0 0 ,(random 1 3) 0))))
(define curse-attack (lambda (x y w)
                       (set-BATTLE-TEXT! w (cons "SPECIAL-A-CON2" 0))
                       (set-BATTLE-STATUS! w (list (CHARACTER-Name y) "CURSE-ATTACK" (CHARACTER-Name x) "呪い"))
                       (sleep 1)
                       (set-CHARACTER-Ali! x `(0 0 0 0 0 ,(random 1 3)))))
