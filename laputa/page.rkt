...
(define P152 (pages 152 "B" 0 '(157 124) (bitmap/file "picture/152.png") 2))
(define P153 (pages 153 "HPAC" 0 '(次のページ) (bitmap/file "picture/153.png") '(0 1 "ブラックジャック" 1)))
;(define P??? (pages 148 "SAI153" 0 '(158の分離先複数) (bitmap/file "picture/153.png") 0))
...
;(define P158a (pages 158a "B" 0 '(151 118) (bitmap/file "picture/158.png") 2))
;(define P158b (pages 158b "B" 0 '(151 118) (bitmap/file "picture/158.png") 2))
;(define P158c (pages 158c "B" 0 '(151 118) (bitmap/file "picture/158.png") 2))
...
(define P169 (pages 169 "HPAC" 0 '(次のページ) (bitmap/file "picture/169.png") '(-1 0)))
;(define P??? (pages ??? "SAI007" 0 '(999) (bitmap/file "picture/169.png") '("Ap" 229 205))
